...
public class CreatePortableCollection
{
    ...
    public void doIt(String file) throws IOException
    {
        try (PDDocument doc = new PDDocument())
        {
            ...
            fs1.setFile("Acta1.pdf");
            fs1.setFileUnicode("Acta1.pdf");

            // Lee el archivo PDF desde el sistema de archivos
            byte[] data1 = convertFileToByteArray("D:\\\\101897.pdf");
            ...
            fs1.setFileDescription("Archivo de acta 1");
            ...
            fs2.setFile("Acta2.pdf");
            fs2.setFileUnicode("Acta2.pdf");


            //create a dummy file stream, this would probably normally be a FileInputStream
            byte[] data2 = convertFileToByteArray("D:\\\\101896.pdf");
            PDEmbeddedFile ef2 = new PDEmbeddedFile(doc, new ByteArrayInputStream(data2), COSName.FLATE_DECODE);
            //now lets some of the optional parameters
            ef2.setSubtype("application/pdf");
    ...
    public byte[] convertFileToByteArray(String filePath) throws IOException {
        try (InputStream inputStream = new FileInputStream(filePath);
            ...
            // Lee el archivo en bloques de 1024 bytes y escribe en el buffer
            while ((bytesRead = inputStream.read(data, 0, data.length)) != -1) {
                buffer.write(data, 0, bytesRead);
            }
            
            // Convierte el contenido del buffer en un array de bytes
